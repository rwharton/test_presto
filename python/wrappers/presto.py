...
_presto.SQRT2_swigconstant(_presto)
SQRT2 = _presto.SQRT2

_presto.PI_swigconstant(_presto)
PI = _presto.PI

_presto.TWOPI_swigconstant(_presto)
TWOPI = _presto.TWOPI

_presto.DEGTORAD_swigconstant(_presto)
DEGTORAD = _presto.DEGTORAD

_presto.RADTODEG_swigconstant(_presto)
RADTODEG = _presto.RADTODEG

_presto.PIBYTWO_swigconstant(_presto)
PIBYTWO = _presto.PIBYTWO

_presto.SOL_swigconstant(_presto)
SOL = _presto.SOL

_presto.SECPERJULYR_swigconstant(_presto)
SECPERJULYR = _presto.SECPERJULYR

_presto.SECPERDAY_swigconstant(_presto)
SECPERDAY = _presto.SECPERDAY

_presto.ARCSEC2RAD_swigconstant(_presto)
ARCSEC2RAD = _presto.ARCSEC2RAD

_presto.SEC2RAD_swigconstant(_presto)
SEC2RAD = _presto.SEC2RAD

_presto.LOWACC_swigconstant(_presto)
LOWACC = _presto.LOWACC

_presto.HIGHACC_swigconstant(_presto)
HIGHACC = _presto.HIGHACC

_presto.INTERBIN_swigconstant(_presto)
INTERBIN = _presto.INTERBIN

_presto.INTERPOLATE_swigconstant(_presto)
INTERPOLATE = _presto.INTERPOLATE

_presto.NO_CHECK_ALIASED_swigconstant(_presto)
NO_CHECK_ALIASED = _presto.NO_CHECK_ALIASED

_presto.CHECK_ALIASED_swigconstant(_presto)
CHECK_ALIASED = _presto.CHECK_ALIASED

_presto.CONV_swigconstant(_presto)
CONV = _presto.CONV

_presto.CORR_swigconstant(_presto)
CORR = _presto.CORR

_presto.INPLACE_CONV_swigconstant(_presto)
INPLACE_CONV = _presto.INPLACE_CONV

_presto.INPLACE_CORR_swigconstant(_presto)
INPLACE_CORR = _presto.INPLACE_CORR

_presto.FFTDK_swigconstant(_presto)
FFTDK = _presto.FFTDK

_presto.FFTD_swigconstant(_presto)
FFTD = _presto.FFTD

_presto.FFTK_swigconstant(_presto)
FFTK = _presto.FFTK

_presto.NOFFTS_swigconstant(_presto)
NOFFTS = _presto.NOFFTS

_presto.RAW_swigconstant(_presto)
RAW = _presto.RAW

_presto.PREPPED_swigconstant(_presto)
PREPPED = _presto.PREPPED

_presto.FFT_swigconstant(_presto)
FFT = _presto.FFT

_presto.SAME_swigconstant(_presto)
SAME = _presto.SAME

def power_arr(dft, numfreqs):
    return _presto.power_arr(dft, numfreqs)
power_arr = _presto.power_arr

def phase_arr(dft, numfreqs):
    return _presto.phase_arr(dft, numfreqs)
phase_arr = _presto.phase_arr

def dpower_arr(dft, numfreqs):
    return _presto.dpower_arr(dft, numfreqs)
dpower_arr = _presto.dpower_arr

def dphase_arr(dft, numfreqs):
    return _presto.dphase_arr(dft, numfreqs)
...
class DoubleArray(_object):
    ...
    if _newclass:
        dptr = _swig_property(_presto.DoubleArray_dptr_get, _presto.DoubleArray_dptr_set)

    def __init__(self, dptr):
        this = _presto.new_DoubleArray(dptr)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def __getitem__(self, index):
        return _presto.DoubleArray___getitem__(self, index)

    def __setitem__(self, index, val):
        return _presto.DoubleArray___setitem__(self, index, val)
...
class infodata(_object):
    ...
    if _newclass:
        onoff = _swig_property(_presto.infodata_onoff_get, _presto.infodata_onoff_set)
...
class makedata(_object):
    ...
    if _newclass:
        basefilenm = _swig_property(_presto.makedata_basefilenm_get, _presto.makedata_basefilenm_set)
    ...
    if _newclass:
        description = _swig_property(_presto.makedata_description_get, _presto.makedata_description_set)
    __swig_setmethods__["N"] = _presto.makedata_N_set
    __swig_getmethods__["N"] = _presto.makedata_N_get
    if _newclass:
        N = _swig_property(_presto.makedata_N_get, _presto.makedata_N_set)
...
def read_mak_input(mdata):
    return _presto.read_mak_input(mdata)
read_mak_input = _presto.read_mak_input

def read_mak_file(basefilenm, mdata):
    return _presto.read_mak_file(basefilenm, mdata)
read_mak_file = _presto.read_mak_file

def write_mak_file(mdata):
    return _presto.write_mak_file(mdata)
...
class binaryprops(_object):
    ...
    if _newclass:
        asinicerr = _swig_property(_presto.binaryprops_asinicerr_get, _presto.binaryprops_asinicerr_set)
...
class rawbincand(_object):
    ...
    if _newclass:
        full_N = _swig_property(_presto.rawbincand_full_N_get, _presto.rawbincand_full_N_set)
    __swig_setmethods__["full_T"] = _presto.rawbincand_full_T_set
    __swig_getmethods__["full_T"] = _presto.rawbincand_full_T_get
    if _newclass:
        full_T = _swig_property(_presto.rawbincand_full_T_get, _presto.rawbincand_full_T_set)
    ...
    if _newclass:
        full_lo_r = _swig_property(_presto.rawbincand_full_lo_r_get, _presto.rawbincand_full_lo_r_set)
    __swig_setmethods__["mini_N"] = _presto.rawbincand_mini_N_set
    __swig_getmethods__["mini_N"] = _presto.rawbincand_mini_N_get
    if _newclass:
        mini_N = _swig_property(_presto.rawbincand_mini_N_get, _presto.rawbincand_mini_N_set)
    __swig_setmethods__["mini_r"] = _presto.rawbincand_mini_r_set
    __swig_getmethods__["mini_r"] = _presto.rawbincand_mini_r_get
    if _newclass:
        mini_r = _swig_property(_presto.rawbincand_mini_r_get, _presto.rawbincand_mini_r_set)
    ...
    if _newclass:
        mini_power = _swig_property(_presto.rawbincand_mini_power_get, _presto.rawbincand_mini_power_set)
    ...
    if _newclass:
        mini_numsum = _swig_property(_presto.rawbincand_mini_numsum_get, _presto.rawbincand_mini_numsum_set)
    ...
    if _newclass:
        mini_sigma = _swig_property(_presto.rawbincand_mini_sigma_get, _presto.rawbincand_mini_sigma_set)
    __swig_setmethods__["psr_p"] = _presto.rawbincand_psr_p_set
    __swig_getmethods__["psr_p"] = _presto.rawbincand_psr_p_get
    if _newclass:
        psr_p = _swig_property(_presto.rawbincand_psr_p_get, _presto.rawbincand_psr_p_set)
    __swig_setmethods__["orb_p"] = _presto.rawbincand_orb_p_set
    __swig_getmethods__["orb_p"] = _presto.rawbincand_orb_p_get
    if _newclass:
        orb_p = _swig_property(_presto.rawbincand_orb_p_get, _presto.rawbincand_orb_p_set)
...
def read_int(infile, byteswap):
    return _presto.read_int(infile, byteswap)
read_int = _presto.read_int

def read_double(infile, byteswap):
    return _presto.read_double(infile, byteswap)
read_double = _presto.read_double

def frotate(data, numbins, bins_to_left):
    return _presto.frotate(data, numbins, bins_to_left)
frotate = _presto.frotate

def drotate(data, numbins, bins_to_left):
    return _presto.drotate(data, numbins, bins_to_left)
...
def lin_interp_E(E, time, to, dt, maxt):
    return _presto.lin_interp_E(E, time, to, dt, maxt)
lin_interp_E = _presto.lin_interp_E

def E_to_phib(E, numpoints, orb):
    return _presto.E_to_phib(E, numpoints, orb)
E_to_phib = _presto.E_to_phib

def E_to_v(E, numpoints, orb):
    return _presto.E_to_v(E, numpoints, orb)
E_to_v = _presto.E_to_v

def E_to_p(E, numpoints, p_psr, orb):
    return _presto.E_to_p(E, numpoints, p_psr, orb)
E_to_p = _presto.E_to_p

def E_to_z(E, numpoints, p_psr, T, orb):
    return _presto.E_to_z(E, numpoints, p_psr, T, orb)
E_to_z = _presto.E_to_z

def E_to_phib_BT(E, numpoints, orb):
    return _presto.E_to_phib_BT(E, numpoints, orb)
...
def gen_z_response(roffset, numbetween, z, numkern):
    return _presto.gen_z_response(roffset, numbetween, z, numkern)
gen_z_response = _presto.gen_z_response

def gen_w_response(roffset, numbetween, z, w, numkern):
    return _presto.gen_w_response(roffset, numbetween, z, w, numkern)
gen_w_response = _presto.gen_w_response

def gen_bin_response(roffset, numbetween, ppsr, T, orbit, numkern):
    return _presto.gen_bin_response(roffset, numbetween, ppsr, T, orbit, numkern)
gen_bin_response = _presto.gen_bin_response

def get_numphotons(file):
    return _presto.get_numphotons(file)
...
def chisqr(data, numdata, avg, var):
    return _presto.chisqr(data, numdata, avg, var)
...
def read_rawbin_cand(file, cands):
    return _presto.read_rawbin_cand(file, cands)
...
def get_rawbin_cand(filenm, candnum, cand):
    return _presto.get_rawbin_cand(filenm, candnum, cand)
get_rawbin_cand = _presto.get_rawbin_cand

def chkfilelen(file, size):
    return _presto.chkfilelen(file, size)
chkfilelen = _presto.chkfilelen

def read_fcomplex_file(file, firstpt, numpts):
    return _presto.read_fcomplex_file(file, firstpt, numpts)
read_fcomplex_file = _presto.read_fcomplex_file

def read_float_file(file, firstpt, numpts):
    return _presto.read_float_file(file, firstpt, numpts)
read_float_file = _presto.read_float_file

def prune_powers(arr, n, numsumpows):
    return _presto.prune_powers(arr, n, numsumpows)
prune_powers = _presto.prune_powers

def median(arr, n):
    return _presto.median(arr, n)
...
def spread_with_pad(data, numdata, result, numresult, numbetween, numpad):
    return _presto.spread_with_pad(data, numdata, result, numresult, numbetween, numpad)
spread_with_pad = _presto.spread_with_pad

def spread_no_pad(data, numdata, result, numresult, numbetween):
    return _presto.spread_no_pad(data, numdata, result, numresult, numbetween)
spread_no_pad = _presto.spread_no_pad

def paddata(data, numdata, numpad):
    return _presto.paddata(data, numdata, numpad)
paddata = _presto.paddata

def place_complex_kernel(kernel, numkernel, result, numresult):
    return _presto.place_complex_kernel(kernel, numkernel, result, numresult)
place_complex_kernel = _presto.place_complex_kernel

def place_real_kernel(kernel, numkernel, result, numresult):
    return _presto.place_real_kernel(kernel, numkernel, result, numresult)
place_real_kernel = _presto.place_real_kernel

def chop_complex_ends(data, numdata, result, numresult, chopbins):
    return _presto.chop_complex_ends(data, numdata, result, numresult, chopbins)
chop_complex_ends = _presto.chop_complex_ends

def chop_real_ends(data, numdata, result, numresult, chopbins):
    return _presto.chop_real_ends(data, numdata, result, numresult, chopbins)
chop_real_ends = _presto.chop_real_ends

def complex_corr_conv(data, kernel, numdata, ffts, type):
    return _presto.complex_corr_conv(data, kernel, numdata, ffts, type)
complex_corr_conv = _presto.complex_corr_conv

def real_corr_conv(data, kernel, numdata, ffts, type):
    return _presto.real_corr_conv(data, kernel, numdata, ffts, type)
real_corr_conv = _presto.real_corr_conv

def corr_complex(data, numdata, datainf, kern, numkern, kerninf, result, numresult, lobin, numbetween, kern_half_width, optype):
    return _presto.corr_complex(data, numdata, datainf, kern, numkern, kerninf, result, numresult, lobin, numbetween, kern_half_width, optype)
corr_complex = _presto.corr_complex

def stretch_fft(data, numdata, result, numresult):
    return _presto.stretch_fft(data, numdata, result, numresult)
stretch_fft = _presto.stretch_fft

def rz_interp(data, numdata, r, z, kern_half_width):
    return _presto.rz_interp(data, numdata, r, z, kern_half_width)
rz_interp = _presto.rz_interp

def max_r_arr(data, numdata, rin, derivs):
    return _presto.max_r_arr(data, numdata, rin, derivs)
max_r_arr = _presto.max_r_arr

def max_rz_arr(data, numdata, rin, zin, derivs):
    return _presto.max_rz_arr(data, numdata, rin, zin, derivs)
max_rz_arr = _presto.max_rz_arr

def fold_errors(prof, proflen, dt, N, datavar, p, pd, pdd):
    return _presto.fold_errors(prof, proflen, dt, N, datavar, p, pd, pdd)
fold_errors = _presto.fold_errors

def foldfile(datafile, dt, tlo, prof, numprof, startphs, fo, fdot, fdotdot, flags, delays, delaytimes, numdelays, onoffpairs, stats, chiarr):
    return _presto.foldfile(datafile, dt, tlo, prof, numprof, startphs, fo, fdot, fdotdot, flags, delays, delaytimes, numdelays, onoffpairs, stats, chiarr)
foldfile = _presto.foldfile

def fold(data, numdata, dt, tlo, prof, numprof, startphase, buffer, phaseadded, fo, fdot, fdotdot, flags, delays, delaytimes, numdelays, onoffpairs, stats):
    return _presto.fold(data, numdata, dt, tlo, prof, numprof, startphase, buffer, phaseadded, fo, fdot, fdotdot, flags, delays, delaytimes, numdelays, onoffpairs, stats)
fold = _presto.fold

def simplefold(data, numdata, dt, tlo, prof, numprof, startphase, fo, fdot, fdotdot):
    return _presto.simplefold(data, numdata, dt, tlo, prof, numprof, startphase, fo, fdot, fdotdot)
simplefold = _presto.simplefold

def combine_profs(profs, instats, numprofs, proflen, delays, outprof, outstats):
    return _presto.combine_profs(profs, instats, numprofs, proflen, delays, outprof, outstats)
combine_profs = _presto.combine_profs

def doppler(freq_observed, voverc):
    return _presto.doppler(freq_observed, voverc)
doppler = _presto.doppler

def search_minifft(minifft, numminifft, min_orb_p, max_orb_p, cands, numcands, numharmsum, numbetween, numfullfft, timefullfft, lorfullfft, interptype, checkaliased):
    return _presto.search_minifft(minifft, numminifft, min_orb_p, max_orb_p, cands, numcands, numharmsum, numbetween, numfullfft, timefullfft, lorfullfft, interptype, checkaliased)
search_minifft = _presto.search_minifft

def print_rawbincand(cand):
    return _presto.print_rawbincand(cand)
print_rawbincand = _presto.print_rawbincand

def barycenter(topotimes, barytimes, voverc, N, ra, dec, obs, ephem):
    return _presto.barycenter(topotimes, barytimes, voverc, N, ra, dec, obs, ephem)
barycenter = _presto.barycenter

def fftwcall(indata, nn, isign):
    return _presto.fftwcall(indata, nn, isign)
fftwcall = _presto.fftwcall

def tablesixstepfft(indata, nn, isign):
    return _presto.tablesixstepfft(indata, nn, isign)
tablesixstepfft = _presto.tablesixstepfft

def realfft(data, n, isign):
    return _presto.realfft(data, n, isign)
realfft = _presto.realfft

def tree_max_dm(numchan, dt, lofreq, hifreq):
    return _presto.tree_max_dm(numchan, dt, lofreq, hifreq)
tree_max_dm = _presto.tree_max_dm

def smearing_from_bw(dm, center_freq, bandwidth):
    return _presto.smearing_from_bw(dm, center_freq, bandwidth)
smearing_from_bw = _presto.smearing_from_bw

def delay_from_dm(dm, freq_emitted):
    return _presto.delay_from_dm(dm, freq_emitted)
delay_from_dm = _presto.delay_from_dm

def dm_from_delay(delay, freq_emitted):
    return _presto.dm_from_delay(delay, freq_emitted)
dm_from_delay = _presto.dm_from_delay

def dedisp_delays(numchan, dm, lofreq, chanwidth, voverc):
    return _presto.dedisp_delays(numchan, dm, lofreq, chanwidth, voverc)
dedisp_delays = _presto.dedisp_delays

def subband_search_delays(numchan, numsubbands, dm, lofreq, chanwidth, voverc):
    return _presto.subband_search_delays(numchan, numsubbands, dm, lofreq, chanwidth, voverc)
subband_search_delays = _presto.subband_search_delays

def subband_delays(numchanx, numsubbands, dm, lofreq, chanwidth, voverc):
    return _presto.subband_delays(numchanx, numsubbands, dm, lofreq, chanwidth, voverc)
...
def corr_rz_plane(data, numdata, numbetween, startbin, zlo, zhi, numz, fftlen, accuracy):
    return _presto.corr_rz_plane(data, numdata, numbetween, startbin, zlo, zhi, numz, fftlen, accuracy)
corr_rz_plane = _presto.corr_rz_plane

def corr_rz_interp(data, numdata, numbetween, startbin, z, afftlen, accuracy):
    return _presto.corr_rz_interp(data, numdata, numbetween, startbin, z, afftlen, accuracy)
corr_rz_interp = _presto.corr_rz_interp

def events_fdot_correct(events, Nevents, freq, fdot):
    return _presto.events_fdot_correct(events, Nevents, freq, fdot)
events_fdot_correct = _presto.events_fdot_correct

def atwood_search(events, weights, Nevents, Nwin, dt):
    return _presto.atwood_search(events, weights, Nevents, Nwin, dt)
atwood_search = _presto.atwood_search

def corr_loc_pow(powers, numpowers):
    return _presto.corr_loc_pow(powers, numpowers)
