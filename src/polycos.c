...
char *make_polycos(char *parfilenm, infodata * idata, char *polycofilenm)
{
    ...
    if (strcmp(idata->telescope, "GBT") == 0) {
        ...
        scopechar = 't';
        tracklen = 12;
   } else if (strcmp(idata->telescope, "Canberra") == 0) {
        scopechar = 'n';
        tracklen = 12;
   } else if (strcmp(idata->telescope, "Goldstone") == 0) {
        scopechar = 'k';
        tracklen = 12;
   } else if (strcmp(idata->telescope, "Robledo") == 0) {
        scopechar = 'j';
        tracklen = 12;
   } else if (strcmp(idata->telescope, "DSS-13") == 0) {
        scopechar = 'o';
        tracklen = 12;
