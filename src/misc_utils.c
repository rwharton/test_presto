...
// name in "outname".
{
    ...
    } else if (strcmp(scope, "canberra") == 0) {
        strcpy(obscode, "CN");
        strcpy(outname, "Canberra");
   } else if (strcmp(scope, "goldstone") == 0) {
        strcpy(obscode, "GS");
        strcpy(outname, "Goldstone");
   } else if (strcmp(scope, "robledo") == 0) {
        strcpy(obscode, "RO");
        strcpy(outname, "Robledo");
   } else if (strcmp(scope, "dss-13") == 0) {
        strcpy(obscode, "S3");
        strcpy(outname, "DSS-13");
    } else {
